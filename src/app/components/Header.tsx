...
export default function Header() {
    ...
    return <header>
        <nav className="bg-white border-gray-200 dark:bg-[#DD81FF]">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
                        <li>
                            <Link href="/" className={`block py-2 pl-3 pr-4 text-white bg-[#DD81FF]-700 rounded md:bg-transparent md:p-0 dark:text-white`} aria-current="page">Home</Link>
                        </li>
                        <li>
                            <Link href="/chat" className={`block py-2 pl-3 pr-4 text-white bg-[#DD81FF]-700 rounded md:bg-transparent md:p-0 dark:text-white`}>Chat</Link>
                        </li>
                    </ul>
                </div>
            </div>
